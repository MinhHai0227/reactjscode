...
const Header = () => {
  ...
  const handleSearch = debounce(async (query) => {
    ...
    setLoading(true);
    try {
      const response = await findComicByName(query);
    ...
    <header>
        ...
        <div className=" max-w-7xl mx-auto h-full flex justify-between items-center p-3">
          ...
          <div className="hidden lg:block top_search lg:w-md relative">
            <input
              ...
              type="text"
              placeholder="Bạn muốn tìm truyện gì ?"
              value={searchQuery}
            ...
            {searchResults.length > 0 && (
              <div className="absolute bg-gray-200 rounded-b-xl w-full z-10 top-11 max-h-72 overflow-y-auto shadow pt-1 flex flex-col gap-2 py-2">
                {searchResults.map((item, index) => (
                  ...
                  >
                    <div className="flex items-center bg-gray-300 p-2">
                      <img className="w-10" src={item.cover_image} alt="" />
          ...
          <div className="login">
            {isLogin ? (
              <ul className="flex gap-2  items-center justify-between">
                <li
                  onClick={() => toggleVisible("showhide1")}
                  className="relative"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li
                  onClick={() => toggleVisible("showhide2")}
                  className="relative"
                >
                  <img
                  ...
                  {isVisible.showhide2 && (
                    <div className="absolute right-0 top-14 z-10 bg-gray-200 p-3 rounded-sm w-60">
                      <ul>
                        ...
                        <li className="hover:shadow p-2 rounded-sm">
                          <Link to="/payment" className="hover:text-amber-500">
                            Nạp Xu
                          </Link>
                        </li>
                        <li className="hover:shadow p-2 rounded-sm">
              ...
              <ul className="flex gap-2 items-center text-white">
                <li>
                  <Link
                    to="/register"
                    className="uppercase bg-amber-500  rounded-md  shadow px-2.5 py-1.5"
                  >
                    đăng kí
                  </Link>
                </li>
      ...
      <div className="duoi bg-amber-500 text-white relative">
        <div className="max-w-7xl mx-auto flex items-center gap-4 mt-2 text-base">
          <span className="hover:bg-amber-400 p-3">
          ...
          <ul className="gap-4 lg:flex hidden">
            ...
            <li className="hover:bg-amber-400 p-3">
          ...
          <div
            onClick={() => toggleHideShow("category3")}
      ...
      {isHideShow.category3 && (
        <div className="mobie lg:hidden bg-amber-500 text-white">
          <ul className="gap-4">
            <li
              onClick={() => toggleHideShow("category1")}
            ...
            <li
              onClick={() => toggleHideShow("category2")}
              className="items-center cursor-pointer"
            >
              <div className="flex items-center hover:bg-amber-400 p-3 ">
                <span>Xếp hạng</span>
